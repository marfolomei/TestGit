        ...
        <div class="sidebar-wrapper">
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa fa-envelope"></i><a href="mailto: <? echo $aboutData['email']?>"><? echo $aboutData['email']?></a></li>
                    <li class="phone"><i class="fa fa-phone"></i><a href="<? echo $aboutData['phone']?>"><? echo $aboutData['phone']?></a></li>
                    <li class="website"><i class="fa fa-globe"></i><a href="<? echo $aboutData['site']?>" target="_blank"><? echo $aboutData['site']?></a></li>

     <li class="github"><i class="fa fa-github"></i><a href="<?echo $aboutData['git']?><!--<!--" target="_blank"><? echo $aboutData['git']?></a></li>
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    ...
                    <h5 class="meta"><?=$education ['college']?></h5>
                    <div class="time"><?=$education ['yearStart']?> -
                        <?=$education ['yearFinish']?></div>
                </div><!--//item-->
                <? } ?>
        ...
        <div class="main-wrapper">
            ...
            <section class="section experiences-section">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title"><?=$car['post']?></h3>
                            <div class="time"><?= $car['yearStart']?>- <?= $car['yearFinish']?></div>
                        </div><!--//upper-row-->
                        <div class="company"><?= $car['place']?></div>
                    </div><!--//meta-->
                    <div class="details">
                        <?= $car['duty']?>
                    </div><!--//details-->
